...
const CustomCollactionnode = ({ id, data }: NodeProps) => {
  ...
  return (
    <div>
      <div className="px-4 py-4 bod4 rounded-md w-80 bg-white border-2 border-white-400 ">
        <div className="flex">
...
export default memo(CustomCollactionnode);
